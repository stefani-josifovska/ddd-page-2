      ...
      <section className={classes.container}>
        ...
        <div className="py-10">
          ...
          <p className="lg:w-9/12 my-4">
            ...
            companies find it difficult to develop all of the compliance
          ...
          <div className="my-24 flex flex-col md:flex-row gap-5">
            <div className="flex-1">
              <h2>Empowering Developers, Enhancing User Experience</h2>
              <p className="lg:w-9/12">
                Our dedication goes beyond serving businesses with invoicing
                solutions; it extends to the software developers who drive
                digital transformation. Through our innovative approach, we have
                developed solutions that cater to both software providers and
                end users.
              </p>
            </div>
          ...
          <div className="text-center my-24 py-10">

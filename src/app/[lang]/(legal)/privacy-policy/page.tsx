...
export const metadata: Metadata = {
  title: "DDD Invoices | Privacy Policy",
  description: "Privacy policy of DDD Invoices.",
};
    ...
    <section className={classes.container}>
      ...
      <ul>
        ...
        <li>
          ...
          refers to DDD Invoices d.o.o., Letališka cesta 32j, 1000 Ljubljana.
        </li>
        <li>
          ...
          of Your brosing history on that website among its many uses.
        </li>
        <li>
          <b>Country</b> refers to: Slovenia.
        </li>
        <li>
        ...
        <li>
          <b>Website</b> refers to DDD Invoices, accessible from
          www.dddinvoices.com
        </li>
        <li>
      ...
      <p>
        ...
        identify You. Personally identifiable information may include, but are
        not limited to:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        close Your web browser. Learn more about cookies on the Privacy Policies
        website article.
      </p>
      <p>
      ...
      <p className="pl-4">Type: Session Cookies</p>
      <p className="pl-4">Administered by: Us</p>
      <p className="pl-4">
      ...
      <p className="pl-4">Type: Persistent Cookies</p>
      <p className="pl-4">Administered by: Us</p>
      <p className="pl-4">
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://dddinvoices.com/privacy-policy">
            https://dddinvoices.com/privacy-policy
          </a>
        </li>
      </ul>
    </section>
